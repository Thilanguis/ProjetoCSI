                    ...
                    <form action="atualizarCliente.php" method="post">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input style="text-align: center;" type="cpf" class="form-control" id="email1" name="cpf" maxlength="11" pattern="([0-9]{11})" title="Digitar o CPF completo sem usar caracteres especiais" value="<?php echo $row["CPF"]; ?>">
                            </div>
